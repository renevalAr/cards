...
(async () => {
  ...
  const longText = Array.from({length: 12}, (_, i) => "строка номер " + (i+1) + " с достаточным количеством слов дл€ переноса").join("\n");
